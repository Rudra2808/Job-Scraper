...
## 📌 Project Overview
This tool is a **Job Aggregation System** designed to scrape, normalize, and combine job listings from multiple job portals into a single structured dataset. It was developed as part of the **Coding Logical Test (2nd Interview Round)**.
